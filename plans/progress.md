...
- 2026-09-05 — Kernel-services architecture added (`docs/agentic-os-kernel-services.md`): gap matrix, external-reference adoption matrix (DeepSeek Harness, herdr, Agent Room, Archify, Omarchy), decisions CR-16…CR-29, types/state transitions/APIs/acceptance for M12–M15, slices K1–K16. Master plan gains M12–M15 and Phase 7b; vNext plan revision 7 gains increments 14–17 sequenced ahead of 8–13 and Phase 9. Planning only; no code.
