...
- **The operator key in `~/.agent-plane/personal/anthropic.key` returned HTTP 401 on 2026-09-24.** The survey re-run and discovery both judged 0. Replace the key before expecting floor candidates.
